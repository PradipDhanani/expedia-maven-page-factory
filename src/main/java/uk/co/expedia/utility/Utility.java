...
public class Utility extends BasePage {
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/uk/co/expedia/screenshot/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/uk/co/expedia/screenshot/" + screenshotName + dateName + ".png";
    ...
    this method will clear previous stored data
     */
    public void clearTextFromField(String element){
        driver.findElement(By.id(element)).sendKeys(Keys.CONTROL + "a");
        driver.findElement(By.id(element)).sendKeys(Keys.DELETE);
    }
